...
The model was trained using work time logs generated by the WorkTrack application:
https://github.com/4l3b/WorkTrack.


The application performs classification of work log events using a single input feature:
